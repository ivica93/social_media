...
router.get("/singlePost/:id", require("../controler/postControler/getSinglePost")); // zanci uvijek prvo rute bez params idu prve
router.get("/:userId", require("../controler/postControler/userPosts"));

//PUT
router.put("/singlePost/:id", verifyToken, require("../controler/postControler/updatePost"));
