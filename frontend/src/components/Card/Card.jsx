  ...
  return (
    <div className='flex flex-col border border-primary rounded-lg overflow-hidden'>
      <div className='relative'>
        ...
        <h3 className='absolute top-[5px] left-[10px] text-white'>{post.user.firstName} {post.user.lastName}</h3>
        <p className='absolute top-[22px] left-[10px] text-white'>{moment(post.createdAt).format("dddd,Ah")}</p>
      ...
      <div className='p-[7px] grow flex flex-col justify-between'>
        ...
        <div className='flex justify-between'>
          <div className='flex items-center gap-[2px]'>
            <AiFillLike className="text-primary text-[20px] cursor-pointer" onClick={handleAddLike} />
          ...
          {post.user._id === user._id ? (
            <div className='flex items-center gap-[2px]'>
              <ImBin className='text-red-700' onClick={handleRemovePost} />
