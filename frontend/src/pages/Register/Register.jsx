      ...
      <div className='lg:ml-[26px]'>
        ...
        <div>
          <div className='border-[0.5px] rounded-lg border-primary mt-[52px]'>
            <form onSubmit={formik.handleSubmit} className='rounded px-[26px] mb-4'>
              ...
              <div className='flex items-center'>
                ...
                <input
                  ...
                  type="file"
                  name='image'
                  className="w-full py-2 px-3 text-gray-900 focus:outline-none focus:shadow-outline"
              ...
              <div className='mt-[26px]'>
                <button type='submit' className='bg-primary w-full hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>Register</button>
              </div>
            </form>
          </div>
        </div>
