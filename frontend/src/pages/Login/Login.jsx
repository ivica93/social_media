  ...
  return (
    <div className='grid lg:grid-cols-2 grid-cols-1 lg:gap-2 lg:mt-[53px] mt-[15px] mb-[23px]'>
      <div>
        <img
          src={loginImage}
          className='object-cover w-full lg:h-[707px]'
          alt='reg-image'
        />
      </div>
      <div className='lg:ml-[26px]'>
        <HeadingTitle title='Login' />
        <div className='w-full lg:mt-[103px] mt-[23px] border-[0.5px] rounded-lg border-primary mt-[55px]'>
          <form
            ...
            <div>
              <button
                type='submit'
                className='bg-primary w-full hover:bg-blue-700 font-bold text-white py-2 px-4 mt-[26px] rounded-lg'>
                Sign in
              </button>
            </div>
          </form>
